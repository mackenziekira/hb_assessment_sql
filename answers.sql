...
SELECT models.name, models.brand_name, brands.headquarters FROM models JOIN brands ON models.brand_name = brands.name WHERE models.name = 'Mustang' AND models.brand_name = 'Ford';
...
SELECT COUNT(name) FROM models WHERE brand_name = 'Ford' GROUP BY brand_name;
...
SELECT b.name, b.founded, m.name FROM brands AS b LEFT JOIN models AS m ON m.brand_name = b.name WHERE b.discontinued IS NULL;
...
SELECT m.name, m.brand_name, b.founded FROM models AS m LEFT JOIN brands AS b ON b.name = m.brand_name WHERE b.name IS NOT NULL;
...
SELECT b.name, b.founded FROM brands AS b LEFT JOIN  models AS m ON b.name = m.brand_name WHERE m.year IS NULL;;
...
SELECT name, year FROM models AS m WHERE year IN (SELECT founded FROM brands);